...
class AtomeFormFragmentTest {
    ...
    fun validInputs_enableSubmitButton() {
        ...
        onView(withId(R.id.edit_phone_number)).perform(typeText("000"), pressImeActionButton())
        ...
        onView(withId(R.id.edit_shipping_street)).perform(typeText("test"), pressImeActionButton())
        onView(withId(R.id.button_submit)).check(matches(not(isEnabled())))
        onView(withId(R.id.button_submit)).perform(scrollTo())
        onView(withId(R.id.edit_shipping_postal)).perform(typeText("test"), pressImeActionButton())
        onView(withId(R.id.button_submit)).check(matches(not(isEnabled())))
        ...
        onView(withId(R.id.edit_full_name)).perform(scrollTo())
        onView(withId(R.id.edit_full_name)).perform(typeText("test"), pressImeActionButton())
        onView(withId(R.id.edit_email)).perform(typeText("test@gmail.com"), pressImeActionButton())
        onView(withId(R.id.button_submit)).check(matches(isEnabled()))
        // optional invalid email should disable submit button after all required fields are filled
        onView(withId(R.id.edit_full_name)).perform(scrollTo())
        onView(withId(R.id.edit_email)).perform(clearText()).perform(typeText("test")).perform(pressImeActionButton())
        onView(withId(R.id.button_submit)).check(matches(not(isEnabled())))
        onView(withId(R.id.edit_full_name)).perform(typeText("test")).perform(pressImeActionButton())

        onView(withId(R.id.edit_email)).perform(clearText()).perform(typeText("test@gmail.com")).perform(pressImeActionButton())
    ...
    fun invalidInputs_disableSubmitButton() {
        onView(withId(R.id.edit_phone_number)).perform(click()).perform(pressImeActionButton())
        onView(withId(R.id.edit_email)).perform(typeText("example@"), pressImeActionButton())
        onView(withId(R.id.edit_full_name)).perform(click()).perform(pressImeActionButton())
        onView(withId(R.id.edit_shipping_country)).perform(scrollTo()).perform(click()).perform(pressImeActionButton())
        onView(withId(R.id.edit_shipping_postal)).perform(click()).perform(pressImeActionButton())
        onView(withId(R.id.button_submit)).check(matches(not(isEnabled())))
    }
    ...
    fun disable_checkBox_submitForm() {
        ...
        onView(withId(R.id.edit_shipping_city)).perform(scrollTo()).perform(typeText("test"), pressImeActionButton())
        onView(withId(R.id.button_submit)).check(matches(not(isEnabled())))
        onView(withId(R.id.edit_shipping_country)).perform(typeText("TH"), pressImeActionButton())
